# Efficient Self-Instruct with a Small Model

**Group Onde Mande** — Kevin Pratama, Alfi Maulana Akbar, Maulana Yusuf Habibi
...
The +11.6 gain on SuperNI (tasks the generator never produced) is the key evidence that Self-Instruct works at 4B scale. See [`laporan_project_v2.md`](laporan_project_v2.md) for the full report and [`results_v3.md`](results_v3.md) for run details.
...
| `laporan_project_v2.md` | Project report (ACL format) |
| `results_v3.md` | Detailed run results and comparison with earlier runs |
